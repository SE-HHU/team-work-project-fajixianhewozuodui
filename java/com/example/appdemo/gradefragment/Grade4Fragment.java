...
public class Grade4Fragment extends Fragment {

    private int[] buttons = new int[11];
    private int[] btns = new int[2];

    private Button ButtonPoint, ButtonCount;
    private Button buttonPoint1, buttonPoint2, buttonPoint3, buttonPoint4, buttonPoint5, buttonPoint6;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_grade4, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ButtonPoint = requireView().findViewById(R.id.Grade4KnowPoint);
        ButtonCount = requireView().findViewById(R.id.Grade4EquCount);

        buttonPoint1 = requireActivity().findViewById(R.id.Grade4Point1);
        buttonPoint2 = requireActivity().findViewById(R.id.Grade4Point2);
        buttonPoint3 = requireActivity().findViewById(R.id.Grade4Point3);
        buttonPoint4 = requireActivity().findViewById(R.id.Grade4Point4);
        buttonPoint5 = requireActivity().findViewById(R.id.Grade4Point5);
        buttonPoint6 = requireActivity().findViewById(R.id.Grade4Point6);

        buttonCount1 = requireActivity().findViewById(R.id.Grade4Count1);
        buttonCount2 = requireActivity().findViewById(R.id.Grade4Count2);
        buttonCount3 = requireActivity().findViewById(R.id.Grade4Count3);
        buttonCount4 = requireActivity().findViewById(R.id.Grade4Count4);

        textView = requireActivity().findViewById(R.id.Grade4textViewCenter);
        ...
        ButtonPoint.setOnClickListener(v -> {
            ...
            ObjectAnimator objectPoint6 = ObjectAnimator.ofFloat(buttonPoint6, "alpha",0f, 1f);
            objectPoint6.setDuration(2000);
        ...
        buttonPoint6.setOnClickListener(v ->{
            ObjectAnimator object = ObjectAnimator.ofFloat(buttonPoint6,"alpha", 0f, 1f);
            object.setDuration(1000);
            if(buttons[5] == 0){
                if(!object.isRunning()){
                    buttonPoint6.setBackgroundResource(R.drawable.ball2);
                    object.start();
                    buttons[5] = 1;

                    GradePage.setChoice(buttons);

                    textView.setText("36 × 107 - 36 × 7 =");
                    if(judge){
                        animationEffect();
                    }
                }
                ...
                if(!object.isRunning()){
                    buttonPoint6.setBackgroundResource(R.drawable.ball);
                    object.start();
                    buttons[5] = 0;
        ...
        buttonCount1.setOnClickListener(v->{
            ...
            if(buttons[6] + buttons[7] + buttons[8] + buttons[9] == 0){
