...
public class Grade2Fragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ButtonPoint = requireView().findViewById(R.id.Grade2KnowPoint);
        ButtonCount = requireView().findViewById(R.id.Grade2EquCount);

        buttonPoint1 = requireActivity().findViewById(R.id.Grade2Point1);
        buttonPoint2 = requireActivity().findViewById(R.id.Grade2Point2);
        buttonPoint3 = requireActivity().findViewById(R.id.Grade2Point3);
        buttonPoint4 = requireActivity().findViewById(R.id.Grade2Point4);

        buttonCount1 = requireActivity().findViewById(R.id.Grade2Count1);
        buttonCount2 = requireActivity().findViewById(R.id.Grade2Count2);
        buttonCount3 = requireActivity().findViewById(R.id.Grade2Count3);
        buttonCount4 = requireActivity().findViewById(R.id.Grade2Count4);

        textView = requireActivity().findViewById(R.id.Grade2textView);
