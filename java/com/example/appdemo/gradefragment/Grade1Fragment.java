...
public class Grade1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_grade1, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        ButtonPoint = requireView().findViewById(R.id.Grade1KnowPoint);
        ButtonCount = requireView().findViewById(R.id.Grade1EquCount);

        buttonPoint1 = requireActivity().findViewById(R.id.Grade1Point1);
        buttonPoint2 = requireActivity().findViewById(R.id.Grade1Point2);
        buttonPoint3 = requireActivity().findViewById(R.id.Grade1Point3);
        buttonPoint4 = requireActivity().findViewById(R.id.Grade1Point4);

        buttonCount1 = requireActivity().findViewById(R.id.Grade1Count1);
        buttonCount2 = requireActivity().findViewById(R.id.Grade1Count2);
        buttonCount3 = requireActivity().findViewById(R.id.Grade1Count3);
        buttonCount4 = requireActivity().findViewById(R.id.Grade1Count4);

        textView = requireActivity().findViewById(R.id.Grade1textView);
