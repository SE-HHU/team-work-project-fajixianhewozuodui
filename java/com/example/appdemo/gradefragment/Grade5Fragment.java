...
public class Grade5Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_grade5, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ButtonPoint = requireView().findViewById(R.id.Grade5KnowPoint);
        ButtonCount = requireView().findViewById(R.id.Grade5EquCount);

        buttonPoint1 = requireActivity().findViewById(R.id.Grade5Point1);
        buttonPoint2 = requireActivity().findViewById(R.id.Grade5Point2);
        buttonPoint3 = requireActivity().findViewById(R.id.Grade5Point3);
        buttonPoint4 = requireActivity().findViewById(R.id.Grade5Point4);
        buttonPoint5 = requireActivity().findViewById(R.id.Grade5Point5);

        buttonCount1 = requireActivity().findViewById(R.id.Grade5Count1);
        buttonCount2 = requireActivity().findViewById(R.id.Grade5Count2);
        buttonCount3 = requireActivity().findViewById(R.id.Grade5Count3);
        buttonCount4 = requireActivity().findViewById(R.id.Grade5Count4);

        up = requireActivity().findViewById(R.id.Grade5textViewUp);
        center = requireActivity().findViewById(R.id.Grade5textViewCenter);
        down = requireActivity().findViewById(R.id.Grade5textViewDown);
        ...
        buttonPoint3.setOnClickListener(v ->{
            ...
            if(buttons[2] == 0){
                if(!object.isRunning()){
                    ...
                    ArrayList<String> arr = SetLevel.setLevel("3/6 =");
        ...
        buttonPoint4.setOnClickListener(v ->{
            ...
            if(buttons[3] == 0){
                if(!object.isRunning()){
                    ...
                    ArrayList<String> arr = SetLevel.setLevel("3/10 + 1/4 =");
                    up.setText(arr.get(0));
                    center.setText(arr.get(1));
                    down.setText(arr.get(2));
        ...
        buttonPoint5.setOnClickListener(v ->{
            ...
            if(buttons[4] == 0){
                if(!object.isRunning()){
                    ...
                    ArrayList<String> arr = SetLevel.setLevel("3/20 + 9/17 - 3/10 =");
                    up.setText(arr.get(0));
                    center.setText(arr.get(1));
                    down.setText(arr.get(2));
